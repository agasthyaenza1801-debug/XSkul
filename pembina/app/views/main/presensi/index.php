...
<?php elseif (($_GET['pesan'] ?? '') === 'sesi_dihapus'): ?>
<div class="mb-6 p-4 bg-emerald-50 border border-emerald-100 rounded-2xl text-emerald-600 text-xs font-bold flex items-center gap-3">
    <i class="bi bi-check-circle-fill text-base"></i>
    Sesi latihan berhasil dihapus beserta presensi & penilaiannya.
</div>
<?php endif; ?>
            ...
            <tbody class="divide-y divide-slate-50">
                ...
                <tr class="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td class="p-4 pr-8 text-right flex items-center justify-end gap-2">
                        ...
                        <form action="<?= APP_URL ?>/presensi/hapusSesi/<?= $s['id'] ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus sesi ini? Semua presensi & penilaian di sesi ini akan ikut terhapus.')">
                            <button type="submit" class="p-2 text-slate-300 hover:text-red-500 transition-colors" title="Hapus Sesi">
